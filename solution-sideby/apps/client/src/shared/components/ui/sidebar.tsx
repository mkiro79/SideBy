  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group sticky top-0 flex h-svh w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground transition-[width] duration-200 ease-linear border-r border-sidebar-border shrink-0",
